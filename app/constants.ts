...
export const TRASH_NODE: FSNode = { id: 'trash', name: '휴지통', type: 'system', parentId: '', createdAt: 0, updatedAt: 0, icon: '🗑️' };
export const TYPE_ORDER: Record<string, number> = { system: 0, app: 1, folder: 2, file: 3 };
